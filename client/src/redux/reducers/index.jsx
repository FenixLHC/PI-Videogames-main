...
export default function rootReducer(state = initialState, action) {
  switch (action.type) {
      ...
      const genreFiltered =
        action.payload === "All"
          ...
          : allVideogames.filter(
              (v) => v.genres?.includes(action.payload) === true
            );
      return {
        ...state,
    ...
    case "ORDER_BY_NAME": {
      ...
      return {
        ...state,
        videogames: action.payload === "name" ? allVideogames : sortedVgs,
      };
    }
    case "ORDER_BY_RATING": {
      ...
      const videogames = state.videogames;
      let sortedVgs = [];
      if (action.payload === "ascRating") {
        sortedVgs= videogames.sort(function (a, b) {
          if (a.rating > b.rating) return 1;
          if (a.rating < b.rating) return -1;
          return 0;
        });
      } else if (action.payload === "descRating") {
        sortedVgs= videogames.sort(function (a, b) {
          if (a.rating < b.rating) return 1;
          if (a.rating > b.rating) return -1;
          return 0;
      ...
      return {
        ...state,
        videogames: action.payload === "rating" ? allVideogames : sortedVgs,
      };
    }
    default:
      return { ...state };
